...
static const unsigned int gappfl         = 20;   /* gap between floating windows (when relevant) */
...
static const Rule clientrules[] = {
	...
	{ .instance = "spbt (t)", .scratchkey = 't', .flags = Floating },
  ...
  { .instance = "spvol (v)", .scratchkey = 'v',  .floatpos = "50% 50% 40% 25%", .flags = Floating },
	...
	{ .class = "Galculator", .flags = Floating|Centered },
